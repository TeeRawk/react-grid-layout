  ...
  (function(_React$Component) {
    ...
    function ReactGridLayout(
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(ReactGridLayout).call(this, props, context)
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "state", {
        ...
        layout: (0, _utils.synchronizeLayoutWithChildren)(
          ...
          _this.props.cols, // Legacy support for verticalCompact: false
      ...
      _defineProperty(_assertThisInitialized(_this), "onDragOver", function(
        ...
        if (!_this.state.droppingDOMNode) {
          ...
          var shouldUpdatePosition =
            _this.state.droppingPosition.x != layerX ||
      ...
      (0, _utils.autoBindHandlers)(_assertThisInitialized(_this), [
        "onDragStart",
        "onDrag",
        "onDragStop",
        "onResizeStart",
