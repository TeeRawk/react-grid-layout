  ...
  (function(_React$Component) {
    ...
    function ResponsiveReactGridLayout() {
      ...
      _defineProperty(
        ...
        "state",
        _this.generateInitialState()
      );

      _defineProperty(_assertThisInitialized(_this), "onLayoutChange", function(
        layout
        /*: Layout*/
      ) {
        _this.props.onLayoutChange(
          ...
          _objectSpread(
            {},
            _this.props.layouts,
            _defineProperty({}, _this.state.breakpoint, layout)
          )
        );
      });
      ...
      [
        {
          ...
          value: function generateInitialState /*: State*/() {
            ...
            var colNo = (0, _responsiveUtils.getColsFromBreakpoint)(
              breakpoint,
              cols
            ); // verticalCompact compatibility, now deprecated

            var compactType =
              this.props.verticalCompact === false
                ? null
                : this.props.compactType; // Get the initial layout. This can tricky; we try to generate one however possible if one doesn't exist
            // for this layout.

            var initialLayout = (0,
            _responsiveUtils.findOrGenerateResponsiveLayout)(
              layouts,
              breakpoints,
              breakpoint,
              breakpoint,
          ...
          value: function componentDidUpdate(
            ...
            if (
              ...
              !(0, _lodash.default)(
                ...
                prevProps.breakpoints
              ) ||
              !(0, _lodash.default)(this.props.cols, prevProps.cols)
            ) {
          ...
          value: function onWidthChange(
            ...
            if (
              ...
              if (!(lastBreakpoint in newLayouts))
                newLayouts[lastBreakpoint] = (0, _utils.cloneLayout)(
                  this.state.layout
